...
contract PEPESJACKPOT is ERC20, Ownable {
    ...
    uint256 public buyWeeklyFee;

    uint256 public sellTotalFees;
    uint256 public sellMarketingFee;
    uint256 public sellLiquidityFee;
    uint256 public sellWeeklyFee;
    ...
    constructor() ERC20("PEPESJACKPOT", unicode"PEPESJACKPOT") {
        ...
        uint256 _buyWeeklyFee = 99;

        uint256 _sellMarketingFee = 1;
        uint256 _sellLiquidityFee = 0;
        uint256 _sellWeeklyFee = 99;

        uint256 totalSupply = 7777777 * (10 ** 18);
        ...
        buyWeeklyFee = _buyWeeklyFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyWeeklyFee;

        sellMarketingFee = _sellMarketingFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellWeeklyFee = _sellWeeklyFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellWeeklyFee;

        marketingWallet = address(0x712bf6aB115E7cEf3511f77AfDB18f4A1D051857); // set as marketing wallet
        weeklyWallet = address(0xa4b28bD1439a7cFFc6D109e74CcDbc0848De78bF); // set as weekly wallet
    ...
    function updateWeeklyWallet(address newWallet) external onlyOwner {
        emit weeklyWalletUpdated(newWallet, weeklyWallet);
        weeklyWallet = newWallet;
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                tokensForWeekly += (fees * sellWeeklyFee) / sellTotalFees;
            ...
            // on buy
                ...
                tokensForWeekly += (fees * buyWeeklyFee) / buyTotalFees;
